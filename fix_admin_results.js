...
const fs = require("fs");
const lines = fs.readFileSync("src/app/admin/results/page.tsx", "utf-8").split("\n");
...
`;
    lines.splice(targetIdx, 0, ui);
}

fs.writeFileSync("src/app/admin/results/page.tsx", lines.join("\\n").replace(/\\\\n/g, "\\n"), "utf-8");
console.log("Success");
