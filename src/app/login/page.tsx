          ...
          <form className="space-y-6 relative z-10" onSubmit={handleLogin}>
            <div>
              ...
              <div className="mt-1 relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-4 focus:ring-slate-100 focus:border-slate-400 sm:text-sm transition-all bg-white/80 backdrop-blur-sm hover:bg-white focus:bg-white text-slate-900 placeholder:text-slate-400 font-medium outline-none"
            ...
            <div>
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center py-3.5 px-4 border border-transparent rounded-xl shadow-sm text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-slate-200 transition-all disabled:opacity-50 group"
              >
                {loading ? (
