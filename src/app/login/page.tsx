...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent relative flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-4 py-3 border border-white/[0.08] rounded-xl focus:ring-4 focus:ring-slate-100 focus:border-slate-400 sm:text-sm transition-all bg-white/80 backdrop-blur-sm hover:bg-white/[0.05] focus:bg-white/[0.05] text-white placeholder:text-slate-500 font-medium outline-none"
