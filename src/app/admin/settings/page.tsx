        ...
        <form onSubmit={handleSave} className="p-8 sm:p-10 space-y-8">
          {message && (
            <motion.div 
              ...
              className={`p-4 rounded-xl text-sm font-semibold border ${message.includes("Error") ? "bg-red-500/10 text-red-400 border-red-500/20" : "bg-emerald-500/10 text-emerald-400 border-emerald-100"}`}
            >
              {message}
            </motion.div>
          )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-8">
            ...
            <div className="space-y-6">
              <h3 className="text-lg font-bold text-white flex items-center border-b border-white/[0.08] pb-4">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="block w-full px-4 py-3 bg-transparent relative/50 border border-white/[0.08] rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 sm:text-sm transition-all text-white outline-none"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-slate-300 mb-2">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-5">
                ...
                <div className="pt-2">
                  <label className="relative flex items-center cursor-pointer p-4 bg-transparent relative/50 border border-white/[0.08] rounded-xl hover:bg-transparent relative transition-colors">
                    <input
                      type="checkbox"
                    ...
                    />
                    <div className="w-11 h-6 bg-white/[0.08] peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-100 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[18px] after:left-[18px] after:bg-white/[0.05] after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gradient-to-r from-violet-600 to-fuchsia-500"></div>
                    <div className="ml-4 flex flex-col">
                      <span className="text-sm font-bold text-white">Show Leaderboard Publicly</span>
                      <span className="text-xs font-medium text-slate-400">Toggle live points on the public page</span>
                    </div>
                  </label>
                </div>
              </div>
            ...
            {/* Poster Template */}
            <div className="lg:col-span-2 space-y-6 pt-4 border-t border-white/[0.08]">
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 bg-transparent relative/50 border border-white/[0.08] rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 sm:text-sm transition-all text-white outline-none"
                />
                <p className="mt-2 text-xs font-medium text-slate-400">Provide a URL for the background image used in the Custom Result Poster generator.</p>
              </div>
            </div>
          ...
          <div className="flex justify-end pt-8 border-t border-white/[0.08]">
            <motion.button
              ...
              type="submit"
              disabled={saving}
              className="inline-flex items-center px-6 py-3 border border-transparent rounded-xl shadow-sm shadow-[0_0_20px_rgba(168,85,247,0.2)] text-sm font-bold text-white bg-gradient-to-r from-violet-600 to-fuchsia-500 hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] focus:outline-none focus:ring-4 focus:ring-indigo-100 disabled:opacity-50 transition-all"
            >
