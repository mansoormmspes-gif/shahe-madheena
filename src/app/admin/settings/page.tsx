        ...
        <form onSubmit={handleSave} className="p-8 sm:p-10 space-y-8">
          ...
          <div className="flex justify-end pt-8 border-t border-slate-100">
            <motion.button
              ...
              type="submit"
              disabled={saving}
              className="inline-flex items-center px-6 py-3 border border-transparent rounded-xl shadow-sm shadow-indigo-600/20 text-sm font-bold text-slate-900 bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-100 disabled:opacity-50 transition-all"
            >
